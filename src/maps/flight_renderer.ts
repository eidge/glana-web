...
export default class FlightRenderer {
  ...
  constructor(map: Map, flight: SavedFlight, options: Options = {}) {
    ...
    console.log(
      ...
      this.trackSegments[0].startIndex,
      this.trackSegments[0].endIndex,
      this.trackSegments[1].startIndex,
      this.trackSegments[1].endIndex,
      this.trackSegments[2].startIndex,
      this.trackSegments[2].endIndex,
      this.flight.getDatums().length
    );
